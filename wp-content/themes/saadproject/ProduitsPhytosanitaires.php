<?php
/**
 * Template Name: Produits phytosanitaires
 * Description: This is Produits phytosanitaires .
 *
 */
...
$title_produits_phytosanitaires = get_field('title_produits_phytosanitaires');
$image_about = get_field('image_about');
$icon_about = get_field('icon_about');
$title_about = get_field('title_about');
$paragraph_about = get_field('paragraph_about');
$list_produits_phytosanitaires_et_fertilisants_about = get_field('list_produits_phytosanitaires_et_fertilisants_about');
$title_explorer_nos_categories = get_field('title_explorer_nos_categories');
$text_produits_phytosanitaires = get_field('text_produits_phytosanitaires');
...
<section class="container my-5 py-5">
    <div class="row justify-content-around my-5">
        <div class="col-xl-5 col-sm-12 p-1 image_semences_about">
            <img class="w-100 bg_in_image z-2" src="<?php echo $image_about; ?>" alt="" srcset="">
        </div>
        <div class="col-xl-5 col-sm-12 p-1 ">
            <img src="<?php echo $icon_about; ?>" alt="" srcset="">
            ...
            <?php
            if ($list_produits_phytosanitaires_et_fertilisants_about) {
                foreach ($list_produits_phytosanitaires_et_fertilisants_about as $item) {
                    $title = $item['list_produits_phytosanitaires_et_fertilisants']; ?>
                    <p>
...
<section class="container my-5 py-5">
    <p class='Semences'>
        <?php echo $title_produits_phytosanitaires; ?>
    </p>
    <div class="row justify-content-between">
        ...
        <div class="col-xl-6 col-sm-12">
            <p class='text_right_in_Content' style="font-size: 16px;">
                <?php echo $text_produits_phytosanitaires; ?>
            </p>
        </div>
    </div>
    <div class="container">
        <div class="row my-5 justify-content-center">
            ...
            if ($product_explorer_nos_categories) {
                foreach ($product_explorer_nos_categories as $item) {
                    ...
                    $backgroun_image_product = $item['backgroun_image_product']; ?>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 my-3  image-container px-2">
                        <img src=<?php echo $backgroun_image_product; ?>>
